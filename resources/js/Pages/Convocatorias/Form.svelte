...
<form on:submit|preventDefault={submit} class="col-span-2">
    <fieldset class="px-8" disabled={isSuperAdmin || checkPermission(authUser, [19]) ? undefined : true}>
        <div class="mt-4">
            ...
            <div>
                <Label required labelFor="entidad" value="Entidad" />
                <Input id="entidad" type="text" class="mt-1" bind:value={$form.entidad} error={errors.entidad} required />
            </div>
            ...
            <div>
                <Label required labelFor="v" value="Fecha de finalización" />
            ...
            <div class="mt-4">
                <Label required labelFor="detalles" value="Detalles" />
                <Textarea maxlength="40000" id="detalles" bind:value={$form.detalles} error={errors.detalles} required />
            </div>

            <div>
                <Label required labelFor="link_mas_informacion" value="Enlace para más información" />
                <Input id="link_mas_informacion" type="text" class="mt-1" bind:value={$form.link_mas_informacion} error={errors.link_mas_informacion} required />
            </div>
